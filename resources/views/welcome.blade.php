    ...
    <div class="subheader py-2 py-lg-12 subheader-transparent" id="kt_subheader">
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center">
                <!--begin::Button-->
                @if(Auth::check())
                <a href="{{url('blog/create')}}" class="btn btn-transparent-white font-weight-bold py-3 px-6 mr-2">Create Blog</a>
                @endif
                <!--end::Button-->
            </div>
            <!--end::Toolbar-->
     ...
     function getinfo(url){
        $.get(url, function(data, status){
          ...
          $.each( JSON.parse(data), function(key, value) {
             ...
             if(user_id==value.user_id||value.user.role=='admin'){
                button='<div class="d-flex align-items-center">'+
                            ' <span data-id="'+btoa(value.id)+'" data-info="'+is_info+'" style="cursor: pointer;" title="On/off" class="on-off symbol symbol-45 symbol-light mr-3" >'+
								...
								'</g></svg></span>'+
                                 '</div>'+
                             '</span>'+
                            ' <a href="{{url("/blog/update")}}/'+btoa(value.id)+'" title="Edit" class="symbol symbol-45 symbol-light mr-3">'+
                                ' <div class="symbol-label">'+
									...
									'</svg></span>'+
                                 '</div>'+
                             '</a><span title="Delete" style="cursor: pointer;" data-id="'+btoa(value.id)+'"  class="delete_notes symbol symbol-45 symbol-light">'+
                                 '<div class="symbol-label">'+
                                   '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">'+
                                        ' <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">'+
                                            ' <rect x="0" y="0" width="24" height="24"></rect>'+
